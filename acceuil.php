...
<form method="post" id="myform" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >  
	...
	<div class="row clearfix"> 
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card" style="background-image: url('hck.png');background-repeat: no-repeat;width:100%;height:100%;margin:0 auto">
				
                    <div class="header">
                        <h2><strong></strong> <small><a href="#" target=""></a></small> </h2>
                    </div>
