(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: true, format: 'YYYY-MM-DD', minDate: null, maxDate: null, currentDate: null, lang: 'fr', weekStart: 0, shortTime: false, clearButton: false, nowButton: false, cancelText: 'Annuler', okText: 'Valider', clearText: 'Reinitialiser', nowText: 'Now', switchOnClick: false};
