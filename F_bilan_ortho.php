...
<title>::  :: Bilan orthophonique</title>
...
<body class="theme-purple" cz-shortcut-listen="true" oncontextmenu="javascript:alert('success!');return false;">
<!-- Page Loader -->
	...
	<!--start -->
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2> <strong>bilan orthophonique</strong> <small>patient  </small></h2>
                    </div>
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-md-6">
								...
								<b>Nom:</b><p>Nom</p></div>
								<div class="input-group">
								<b>Date de naissance:</b><p>00/00/0000</p>
								</div>
								<div class="input-group">
								<b>Date de la 1ere implantation:</b><p>00/00/0000</p>
								</div>
                                <div class="input-group">
								<b>Numero du dossier:</b><p>000000</p>
								</div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
								<b>Prenom:</b><p>Prenom</p>
								</div>
								<div class="input-group">
								<b>Age de l'implantation:</b><p>00 ans et 00 mois</p>
								</div>
								<div class="input-group">
								<b>Recul:</b><p>-00 ans et 00 mois</p>
								</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="body">
						...
						<div class="col-md-6">
						   <div class="col-md-12">
								...
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">protocol par implant droit</option>
                                    <option value="eu">Pre implantation</option>
									<option value="fe">Pre implantation</option>
                                    <option value="fs">Pre implantation</option>
									<option value="ps">Pre implantation</option>
									<option value="ps">Pre implantation</option>
								</select>
								</div>
                            </div>
                            <div class="col-md-12">
                               <div class="input-group">
                                        ...
                                        <input id="dp" placeholder="Date du bilan orthophonique" name="dp" style="background-color: transparent;
							...
							<div class="col-md-12">
                                <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Marque d'implan droit</option>
                                    <option value="eu">Marque</option>
									<option value="fe">Marque</option>
                                    <option value="fs">Marque</option>
									<option value="ps">Marque</option>
									<option value="ps">Marque</option>
								</select>
								</div>
                            </div>
							<div class="col-md-12">                      
								 <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Processeur droit</option>
                                    <option value="eu">Marque</option>
									<option value="fe">Marque</option>
                                    <option value="fs">Marque</option>
									<option value="ps">Marque</option>
							...
							<div class="col-md-12">
                                 <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Marque d'implan gauche</option>
                                    <option value="eu">Marque</option>
									<option value="fe">Marque</option>
                                    <option value="fs">Marque</option>
									<option value="ps">Marque</option>
							...
							<div class="col-md-12">
                                 <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Processeur gauche</option>
                                    <option value="eu">Marque</option>
									<option value="fe">Marque</option>
                                    <option value="fs">Marque</option>
									<option value="ps">Marque</option>
							...
							<div class="col-md-12 input-group" style="margin-top:10px">
                               <input type="checkbox" name="bil" id="bil" value="bil">
                                <label for="bil" style="color:grey ; margin-bottom:10px">
                                        Impalnt bilateral
                                </label> &nbsp; &nbsp; &nbsp;
								<input type="checkbox" name="appa" id="appa" value="appa">
                                <label for="appa" style="color:grey ; margin-bottom:10px">
                                        2 appareils
                                </label>
                            </div>
							<div class="col-md-12">
                                 <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Centre</option>
                                    <option value="eu">Centre</option>
									<option value="fe">Centre</option>
                                    <option value="fs">Centre</option>
									<option value="ps">Centre</option>
									<option value="ps">Centre</option>
								</select>
								</div>
                            </div>
							<div class="col-md-12">
                                 <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Orthophoniste de centre</option>
                                    <option value="eu">Centre</option>
									<option value="fe">Centre</option>
                                    <option value="fs">Centre</option>
									<option value="ps">Centre</option>
							...
							<div class="col-md-12">
                                 <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Orthophoniste Liberal</option>
                                    <option value="eu">Centre</option>
									<option value="fe">Centre</option>
                                    <option value="fs">Centre</option>
									<option value="ps">Centre</option>
							...
							<div class="col-md-12" style="">                      
								<div class="form-group form-float" >                                    
                                    <input type="number" class="form-control" name="code" id="code" data-rule="quantity" placeholder="Nombre de seances individuelles" style="font-size:15px">
                                   
                                </div>
                            </div>
							<div class="col-md-12" style="">                      
								<div class="form-group form-float" >                                    
                                    <input type="number" class="form-control" name="code" id="code" data-rule="quantity" placeholder="Nombre de seances en groupe" style="font-size:15px">
                                   
                                </div>
                            </div>
							<div class="col-md-12" style="">                      
								<div class="form-group form-float" >                                    
                                    <input type="number" class="form-control" name="code" id="code" data-rule="quantity" placeholder="Temps d'une seance (minutes)" style="font-size:15px">
							...
							<div class="col-md-12">
                                 <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Audioprothesiste</option>
                                    <option value="eu">Centre</option>
									<option value="fe">Centre</option>
                                    <option value="fs">Centre</option>
									<option value="ps">Centre</option>
							...
							<div class="col-md-12">
                                 <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Type de scolarité actuel</option>
                                    <option value="eu">Centre</option>
									<option value="fe">Centre</option>
                                    <option value="fs">Centre</option>
									<option value="ps">Centre</option>
							...
							<div class="col-md-12">
                                 <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Niveau scolaire actuel</option>
                                    <option value="eu">Centre</option>
									<option value="fe">Centre</option>
                                    <option value="fs">Centre</option>
									<option value="ps">Centre</option>
							...
							<div class="col-md-12">
                                <div class="form-group form-float">
                                    <textarea name="Adresse" id="Adresse" cols="30" rows="1" placeholder="Comportement" style="font-size:15px" class="form-control no-resize" required></textarea>
                                </div>
                            </div>
						...
						<div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                 <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Protocole post implant gauche</option>
                                    <option value="eu">Centre</option>
									<option value="fe">Centre</option>
                                    <option value="fs">Centre</option>
									<option value="ps">Centre</option>
							...
							<div class="col-md-12">
                                 <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Orthophoniste referente</option>
                                    <option value="eu">Centre</option>
									<option value="fe">Centre</option>
                                    <option value="fs">Centre</option>
									<option value="ps">Centre</option>
							...
							<div class="col-md-12">
                                 <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Type d'implant droit</option>
                                    <option value="eu">Centre</option>
									<option value="fe">Centre</option>
                                    <option value="fs">Centre</option>
									<option value="ps">Centre</option>
							...
							<div class="col-md-12">
                                 <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Type d'implant gauche</option>
                                    <option value="eu">Centre</option>
									<option value="fe">Centre</option>
                                    <option value="fs">Centre</option>
									<option value="ps">Centre</option>
							...
							<div>
							<div class="">
                                <input type="checkbox" name="pctl" id="pctl" value="pctl">
                                <label for="pctl" style="color:grey ; margin-bottom:10px">
                                        Prothese controlaterale
                                </label>
                            </div>
							</div>
							</div>
							<div class="col-md-12">
                               <div class="input-group">
                                        ...
                                        <input id="dp" placeholder="Date du dernier reglage" name="dp" style="background-color: transparent;
										border: 1px solid #E3E3E3;
										border-radius: 30px;
										color: #2c2c2c;
							...
							<p> <b></b> </p>
								...
								<select class="form-control text-center" tabindex="" id="type" name="type">
							...
							<div class="btn-group bootstrap-select form-control show-tick" >
								<select class="form-control show-tick" tabindex="" style="" id="langue" name="langue">
                                   <option selected="selected" style="">Langue familiale</option>
						...
						<!--select-->
							...
							<p> <b></b> </p>
								...
								<select class="form-control show-tick" tabindex="" id="niv_sco" name="niv_sco">
                                    <option selected="selected">Niveau scolaire initial</option>
                                    <option value="Pri">Primaire</option>
                                    <option value="Sec">Secondaire </option>
									<option value="Lyc">Lycée</option>
                                    <option value="Uni">Universitaire </option>
                                </select></div>
						...
						<!--checkbox-->
							...
							<div class="">
                                ...
                                <label for="c9" style="color:grey; margin-bottom:10px">
                                        Ne porte plus d'implant gauche
                                </label>
                            </div>
							</div>
							</div>
...
<script src="js/range-sliders.js"></script>
