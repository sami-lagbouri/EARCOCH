...
if (isset($_POST['obspt'])) $obspt = $_POST['obspt'];
   ...
   $sql = "insert into reg_surd(idpatient_surd, agacq_surd, poids_surd, grss_accch_surd, etlg_surd, ant_pers_surd, antcfam_surd, cnsng_surd,apgar_surd, infcong_pre_surd, sub_pre_surd, sff_per_surd, cpost_surd, trbl_surd, trbl_syn_surd, obsrv_surd, collab_surd,
observinter_surd, orthref_surd, chir_surd, ortho_surd, reg_surd, audio_surd, check_surd) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?)";
   ...
   $stmt= $db->prepare($sql);
	...
	$stmt-> execute(array($num_doss,$ag_ac_mrch,$pn_kg,$gross_accou,$etlg,$ant_per,$ant_fam,$cnsg,$apgar,$inf_cng,$sub_trtg,$cs_pr_nt,$a_xx,$trbl_asso,$trbl_synd,$obs_plus,$col_orth,$obspt,$orft,$chrgpt,$orcpt,$rglp,$auptst,1));
						 ...
						 <div class="col-md-12">
                            ...
                            <div class="col-md-12" style="" >
								...
								<select id="gross_accou" name="gross_accou" class="form-control">
                                    ...
                                    <option value="3">Incertain</option>
								</select>
								</div>
							</div>
							<div class="col-md-12" style="">                      
                        ...
                        <div class="row clearfix">
                            <div class="col-md-6">
                               ...
                               <div class="btn-group bootstrap-select form-control show-tick">
								<select class="form-control show-tick" tabindex="" id="inf_cng" name="inf_cng" >
                                    ...
                                    <option value="1">Rubéole</option>
									<option value="2">CMV</option>
									<option value="3">Toxoplasmose</option>
                            ...
                            <div class="col-md-6">
								...
								<select class="form-control show-tick" tabindex="" id="sub_trtg" name="sub_trtg" >
                                    ...
                                    <option value="1">Thalidomide</option>
									<option value="2">Syndrome alcoolo-fœtal</option>
									<option value="3">Cocaïne</option>
									<option value="4">Radiothérapie lors du premier trimestre</option>
									<option value="5">Aminosides durant la grossesse</option>
                        ...
                        <div class="row clearfix">
                            <div class="col-md-12">
								...
								<select class="form-control show-tick" tabindex="" id="cs_pr_nt" name="cs_pr_nt" >
									...
									<option value="1">Souffrance fœtale aigue</option>
                                    <option value="2">Hypotrophie</option>
									<option value="3">Prématurité</option>
									<option value="4">Anoxie</option>
									<option value="5">Hyperbilirubinémie</option>
									<option value="6">Ototoxicité médicamenteuse</option>
                                    <option value="7">Traumatismes sonores</option>
									<option value="8">Traumatismes crâniens</option>
									<option value="9">Convulsions</option>
                        ...
                        <div class="row clearfix">
                            <div class="col-md-6">
								...
								<select class="form-control show-tick" tabindex="" id="trbl_asso" name="trbl_asso" >
                                    ...
                                    <option value="1">TSA</option>
									<option value="2">Trisomie</option>
									<option value="3">TDHA</option>
									<option value="4">Retard mental</option>
									<option value="5">Retard psychomoteur</option>
                                    <option value="6">IMC</option>
									<option value="7">Dysmorphie faciale</option>
                            ...
                            <div class="col-md-6">
								...
								<select class="form-control show-tick" tabindex="" id="trbl_synd" name="trbl_synd" >
									...
									<option value="2">Syndrome de Waadenburg-Klein</option>
									<option value="3">Syndrome de Pendred</option>
									<option value="4">Syndrome de Jarwel-Lange-Nielsen</option>
									<option value="5">Syndrome Charge</option>
                                    <option value="6">Syndrome de Branchio-oto-rénal (BOR)</option>
									<option value="7">Syndrome d’Alport</option>
									<option value="8">NF2</option>
