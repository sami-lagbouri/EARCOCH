...
if($_SERVER["REQUEST_METHOD"] == "POST"){
   ...
   $sql = "insert into reg_cnslt(cr_cnslt, idpat_cnslt, coch_cnslt, check_cnslt) values ( ?, ?, ?,?)";
  ...
  $comp=$tdm_cslt .';'.  $irm_cslt;
   ...
   $stmt= $db -> prepare($sql);
	...
	$stmt -> execute(array($cr_cslt_1,$pat_cons,$comp,1));
                ...
                <div class="card">
                    ...
                    <div class="body">
						...
						<div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-float">
									<textarea name="cr_cslt_1" id="cr_cslt_1" cols="30" rows="1" placeholder="Compte rendu" style="font-size:15px" class="form-control no-resize" ></textarea>
								</div>
                            </div>
							<div class="col-md-12">
                                <div class="form-group form-float">
						...
						<div class="col-xs-6 col-md-6" style="display: flex; justify-content: flex-end">
                                 ...
                                 <div>
								<input type="checkbox" name="tdm_cslt" id="tdm_cslt" value="tdm_cslt" >
								<label for="tdm_cslt" style="color:#888;margin-bottom:10px">
                                        TDM
                                </label>  
								<input type="checkbox" name="irm_cslt" id="irm_cslt" value="irm_cslt" >
