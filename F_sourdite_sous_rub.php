                ...
                <ul class="list">
                    ...
                    <li class=""> <a href="javascript:void(0);" class="menu-toggle" style="font-weight:bold"><i class="fas fa-user-injured"></i><span>Patient</span> </a>
                        <ul class="ml-menu">
                            ...
                            <li><a href="javascript:void(0);" class="menu-toggle" style=""><span style="">Fiche de surdité</span> </a>
                        <ul class="ml-menu">
							<li><a href="Motif_de_consult.php">Motif de consultaion</a></li>
                            <li><a href="Anteced_medecau.php">Antecedants medicaux</a></li>
                            <li><a href="Pro_ch_pat.php">Profesionnels en charge du patient</a></li>
...
<script src="js/jquery.validate.js"></script> <!-- Jquery Validation Plugin Css -->
<script src="js/jquery.steps.js"></script> <!-- JQuery Steps Plugin Js -->
<script>
