...
<form method="post" id="myform" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >  
	...
	<div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2> <strong>Chirurgie</strong> <small><a href="#" target="">Patient</a></small> </h2>
                    </div>
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-md-6">
								...
								<div class="input-group">
								<b>Date de naissance :</b><p>00/00/0000</p></div>
								
                                <div class="input-group">
								<b>Date de 1er implentation :</b><p>00/00/0000</p></div>
								
								<div class="input-group">
								<b>Numero du dossier :</b><p>000000</p></div>
								<div class="form-group form-float">
								 <input id="d_c" placeholder="Date de la chirurgie" name="d_c" style="" class="form-control" readonly>
								</div>
								
								 <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Chirurgie</option>
                                    <option value="pre">Préalable</option>
									<option value="trs">Trouseau</option>
                                </select>
								</div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
								<b>Prenom :</b><p>prenom</p></div>
								
								<div class="input-group">
								<b>Age de l'implant :</b><p>00 ans et 00</p></div>
								
                                <div class="input-group">
								<b>Recul :</b><p>00 ans et 00</p></div>
	...
	<div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2> <strong>Bilan d'imagerie</strong> <small><a href="#" target="">Patient</a></small> </h2>
                    </div>
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-md-6">
	...
	<div class="row clearfix"> 
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="header">
                        <h2><strong>Scanner</strong> </h2>
                    </div></div> 
                            </div>
						   <div class="col-md-12">
                                <div class="form-group form-float">                                    
                                    
								 <input id="d_c" placeholder="Scanner du" name="d_c" style="" class="form-control" readonly>
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-float">
									<input type="text" class="form-control" placeholder="Service" name="Service" required style="font-size:15px" id="Service">
								</div>
                            </div>
							<div class="col-md-12">
                                <div class="form-group form-float">
                                   <div class="radio inlineblock">
                                    <input type="radio" name="synt" id="normal" class="with-gap" value="normal">
                                    <label for="normal">Normal</label>
                                </div>
								<div class="radio inlineblock">
                                    <input type="radio" name="synt" id="anomalie" class="with-gap" value="anomalie">
                                    <label for="anomalie">Anomalie</label>
                                </div>
								<div class=" inlineblock">
								<input type="checkbox" name="om" id="om" value="om">
                                <label for="om" style="color:grey ; margin-bottom:10px">
                                        O.M
                                </label>
								</div>
                                </div>
							...
							<div class="col-md-12 " style="text-align:center">                      
								<b> Oreille droite</b>&nbsp; &nbsp; &nbsp; <b>Oreille gauche</b>
                            </div>
                    ...
                    <div class="header">
                        <h2><strong>IRM</strong> </h2>
							...
							<div class="col-md-12">
                                <div class="form-group form-float">
                                   <div class="radio inlineblock">
                                    <input type="radio" name="synti" id="normali" class="with-gap" value="normal">
                                    <label for="normali">Normal</label>
                                </div>
								<div class="radio inlineblock">
                                    <input type="radio" name="synti" id="anomaliei" class="with-gap" value="anomalie">
                                    <label for="anomaliei">Anomalie</label>
                                </div>
								<div class=" inlineblock">
								<input type="checkbox" name="omi" id="omi" value="omi">
                                <label for="omi" style="color:grey ; margin-bottom:10px">
                                        SNC
                                </label>
								</div>
                                </div>
	...
	<div class="row clearfix">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="form-group">                                   
                                   <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">CAI</option>
                                    <option value="pre">Préalable</option>
									<option value="trs">Trouseau</option>
                                </select>
								</div>                                   
							 ...
							 <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="form-group">                                   
                                    <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Nerf cochleaire</option>
                                    <option value="pre">Préalable</option>
									<option value="trs">Trouseau</option>
                                </select>
								</div>                                   
							 ...
							 <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="form-group">                                   
                                   <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">CSC</option>
                                    <option value="pre">Préalable</option>
									<option value="trs">Trouseau</option>
                                </select>
								</div>                                   
							 ...
							 <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="form-group">                                   
                                    <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Lab post</option>
                                    <option value="pre">Préalable</option>
									<option value="trs">Trouseau</option>
                                </select>
								</div>                                   
							 ...
							 <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="form-group">                                   
                                   <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Vest</option>
                                    <option value="pre">Préalable</option>
									<option value="trs">Trouseau</option>
                                </select>
								</div>                                   
							 ...
							 <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="form-group">                                   
                                    <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Cochlee</option>
                                    <option value="pre">Préalable</option>
									<option value="trs">Trouseau</option>
                                </select>
								</div>                                   
							 ...
							 <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="form-group">                                   
                                   <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Coch</option>
                                    <option value="pre">Préalable</option>
									<option value="trs">Trouseau</option>
                                </select>
								</div>                                   
							 ...
							 <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="form-group">                                   
                                    <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">SNC</option>
                                    <option value="pre">Préalable</option>
									<option value="trs">Trouseau</option>
                                </select>
								</div>                                   
							 ...
							 <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="form-group">                                   
                                   <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Ag V</option>
                                    <option value="pre">Préalable</option>
									<option value="trs">Trouseau</option>
                                </select>
								</div>                                   
							 ...
							 <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="form-group">                                   
                                       <textarea name="Adresse" id="Adresse" cols="30" rows="4" placeholder="Commentaire sur scanner et IRM p" style="font-size:15px" class="form-control no-resize" required></textarea>                             
                                </div>
                            </div>
							 <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="form-group">                                   
							 ...
							 <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="form-group">                                   
                                   <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">Ag C</option>
                                    <option value="pre">Préalable</option>
									<option value="trs">Trouseau</option>
                                </select>
								</div>                                   
							 ...
							 <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="form-group">                                   
                                   <div class="btn-group bootstrap-select form-control show-tick">
								<select id="situation" name="situation" class="form-control">
                                    <option selected="selected">O Moy</option>
                                    <option value="pre">Préalable</option>
									<option value="trs">Trouseau</option>
                                </select>
								</div>                                   
