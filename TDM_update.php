...
if($_SERVER["REQUEST_METHOD"] == "POST"){
   ...
   $sql = "update reg_scan set date_scan=?, inject_scan=?, centre_scan=?, conduit_scan=?, caisse_scan=?, chaine_scan=?,
fenronde_scan=?, mastoide_scan=?, canal_scan=?, tegem_scan=?, golfe_scan=?, canalcaro_scan=?, sinus_scan=?, sinustymp_scan=?,
recessus_scan=?, cochle_scan=?, vestibule_scan=?, semicer_scan=?, aqueduc_scan=?, modiolus_scan=?, coduit_scan=?, cerebrale_scan=?, id_pat=? where id_scan=?";
   $error='';
  ...
  if(!empty($_POST['pat_cons'])){
   ...
   $stmt= $db -> prepare($sql);
	...
	$stmt -> execute(array($dp,$inj_prd_con_tdm,$centre,$con_aud_ext,$cai_tdm,$mart_tdm,$fen_tdm,$mast_tdm,$cafa_tdm,$teg_typ,$golf_jur,$ca_ca,$sin_sig,$sin_typ,$re_fa_tdm,$cochl_tdm,$vest_tdm,$casecir_tdm,$aqves_tdm,$mod_tdm,$coai_tdm,$crb_tdm,$pat_cons,$_SESSION['edit_tdm']));
    if($stmt==1) header('Location: scan_liste.php');
...
<form method="post" id="myform" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >  
	...
	<?php 
	$stmt_tdm = $db->query("SELECT * FROM public.reg_scan WHERE id_scan=" . $_SESSION['edit_tdm']);
while($row_tdm = $stmt_tdm->fetch()) {
$date_scan=$row_tdm['date_scan'];
$inject_scan=$row_tdm['inject_scan'];
$centre_scan=$row_tdm['centre_scan'];
$conduit_scan=$row_tdm['conduit_scan'] ;
$caisse_scan=$row_tdm['caisse_scan'];
$chaine_scan=$row_tdm['chaine_scan'];
$fenronde_scan=$row_tdm['fenronde_scan'];
$mastoide_scan=$row_tdm['mastoide_scan'];
$canal_scan=$row_tdm['canal_scan'];
$tegem_scan=$row_tdm['tegem_scan'];
$golfe_scan=$row_tdm['golfe_scan'];
$canalcaro_scan=$row_tdm['canalcaro_scan'];
$sinus_scan=$row_tdm['sinus_scan'];
$sinustymp_scan=$row_tdm['sinustymp_scan'];
$recessus_scan=$row_tdm['recessus_scan'];
$cochle_scan=$row_tdm['cochle_scan'];
$vestibule_scan=$row_tdm['vestibule_scan'];
$semicer_scan=$row_tdm['semicer_scan'];
$aqueduc_scan=$row_tdm['aqueduc_scan'];
$modiolus_scan=$row_tdm['modiolus_scan'];
$coduit_scan=$row_tdm['coduit_scan'];
$cerebrale_scan=$row_tdm['cerebrale_scan'];
$id_pat=$row_tdm['id_pat']	;
} ?>
            <!-- Spinners -->
						   ...
						   <div class="col-md-12" style="" >
								...
								<select name="pat_cons" class="form-control">
									...
									$stmt_o = $db->query("SELECT * FROM reg_pat"); 
										...
										?> 
                                    <option <?php if($row_o["id_pat"]==$id_pat) echo 'selected'?> value="<?php echo $row_o["id_pat"]?>"><?php echo $row_o["nom_pat"].' '.$row_o["prenom_pat"]?></option>
										  <?php }?>
								</select>
								</div>
							</div>
                            <div class="col-md-12">
							 <div class="input-group">
                                        ...
                                        <input id="dp" placeholder="Date de naissance" name="date_tdm" style="background-color: transparent;
										...
										width: 100%;    padding: 10px 18px 10px 18px;    background-clip: padding-box;    background-clip: padding-box;transition: color 0.3s ease-in-out, border-color 0.3s ease-in-out, background-color 0.3s ease-in-out" class="" readonly value="<?php echo $date_scan?>">
                                    </div>
							...
							<div class="col-md-12" style="color:#888">
                                    ...
                                    <input <?php if($inject_scan=='option1') echo 'checked'?> type="radio" name="inj_prd_con_tdm" id="oui" class="with-gap" value="option1">
                                    <label for="oui">Oui</label>
                                </div>                                
                                <div class="radio inlineblock">
                                    <input <?php if($inject_scan=='option2') echo 'checked'?> type="radio" name="inj_prd_con_tdm" id="Non" class="with-gap" value="option2">
							...
							<div class="col-md-12">
                                <div class="form-group form-float">
									<input type="text" class="form-control" placeholder="Centre" id="centre" name="centre" required style="font-size:15px" value="<?php echo $centre_scan?>">
								</div>
                            </div>
							<div class="col-md-12" style="" >
								...
								<select id="con_aud_ext" name="con_aud_ext" class="form-control">
                                    ...
                                    <option <?php if($conduit_scan=='1') echo 'selected'?> value="1">Normal</option>
									<option <?php if($conduit_scan=='2') echo 'selected'?> value="2">Atrésie</option>
                                    <option <?php if($conduit_scan=='3') echo 'selected'?> value="3">Absent</option>
								</select>
								</div>
							</div>
							<div class="col-md-12" style="" >
								...
								<select id="cai_tdm" name="cai_tdm" class="form-control">
                                    ...
                                    <option <?php if($caisse_scan=='1') echo 'selected'?> value="1">Normal</option>
									<option <?php if($caisse_scan=='2') echo 'selected'?> value="2">Hypoplasique</option>
                                    <option <?php if($caisse_scan=='3') echo 'selected'?> value="3">Cloisonnée</option>
                                    <option <?php if($caisse_scan=='4') echo 'selected'?> value="4">Absente</option>
                                    <option <?php if($caisse_scan=='5') echo 'selected'?> value="5">Comblement</option>
                                    <option <?php if($caisse_scan=='6') echo 'selected'?> value="6">Autre</option>
								</select>
								</div>
							</div>
							<div class="col-md-12" style="" >
								...
								<select id="mart_tdm" name="mart_tdm" class="form-control">
                                    ...
                                    <option <?php if($chaine_scan=='1') echo 'selected'?> value="1">Normal</option>
									<option <?php if($chaine_scan=='2') echo 'selected'?> value="2">Hypoplasique</option>
                                    <option <?php if($chaine_scan=='3') echo 'selected'?> value="3">Fixe</option>
                                     </optgroup>
                                    <option <?php if($chaine_scan=='4') echo 'selected'?> value="4">Autre</option>
								
                                    <optgroup label="Enclume">
                                    <option <?php if($chaine_scan=='5') echo 'selected'?> value="5">Normal</option>
									<option <?php if($chaine_scan=='6') echo 'selected'?> value="6">Hypoplasique</option>
                                    <option <?php if($chaine_scan=='7') echo 'selected'?> value="7">Fixe</option>
                                    <option <?php if($chaine_scan=='8') echo 'selected'?> value="8">Fusion uncudo-malléaire</option>
                                    
                                    <option value="9">Autre</option>
								</optgroup>
                                    <optgroup label="Etrier et fenêtre ovale">
                                    <option <?php if($chaine_scan=='9') echo 'selected'?> value="9">Normal</option>
									<option <?php if($chaine_scan=='10') echo 'selected'?> value="10">Hypoplasique</option>
									<option <?php if($chaine_scan=='11') echo 'selected'?> value="11">Absent</option>
                                    </optgroup>
								
                                    <optgroup label="Pyramide">
                                    <option <?php if($chaine_scan=='12') echo 'selected'?> value="12">Présente</option>
									<option <?php if($chaine_scan=='13') echo 'selected'?> value="13">Absente</option>
									 </optgroup>
                              
                                    <optgroup label="Tendon de l’etrier">
                                    <option <?php if($chaine_scan=='14') echo 'selected'?> value="14">Présent</option>
									<option <?php if($chaine_scan=='15') echo 'selected'?> value="15">Ossifié</option>
									<option <?php if($chaine_scan=='16') echo 'selected'?> value="16">Absent</option>
									 </optgroup>
							...
							<div class="col-md-12" style="" >
								...
								<select id="fen_tdm" name="fen_tdm" class="form-control">
                                    ...
                                    <option <?php if($fenronde_scan=='1') echo 'selected'?> value="1">Hypoplasique</option>
									<option <?php if($fenronde_scan=='2') echo 'selected'?> value="2">Aplasique</option>
									<option <?php if($fenronde_scan=='3') echo 'selected'?> value="3">Fenêtre double</option>
									<option <?php if($fenronde_scan=='4') echo 'selected'?> value="4">Calcifiée</option>
									<option <?php if($fenronde_scan=='5') echo 'selected'?> value="5">Autre</option>
							...
							<div class="col-md-12" style="" >
								...
								<select id="mast_tdm" name="mast_tdm" class="form-control">
                                    ...
                                    <option <?php if($fenronde_scan=='1') echo 'selected'?>  value="1">Pneumatisée</option>
									<option <?php if($fenronde_scan=='2') echo 'selected'?>  value="2">Diploique</option>
									<option <?php if($fenronde_scan=='3') echo 'selected'?>  value="3">Sclérotique</option>
							...
							<div class="col-md-12" style="" >
								...
								<select id="cafa_tdm" name="cafa_tdm" class="form-control">
                                    ...
                                    <option <?php if($canal_scan=='1') echo 'selected'?> value="1">Trajet normal</option>
									<option <?php if($canal_scan=='2') echo 'selected'?> value="2">Trajet aberrant</option>
									<option <?php if($canal_scan=='3') echo 'selected'?> value="3">Hypoplasique</option>
									<option <?php if($canal_scan=='4') echo 'selected'?> value="4">Aplasique</option>
									<option <?php if($canal_scan=='5') echo 'selected'?> value="5">Dédoublement</option>
									<option <?php if($canal_scan=='6') echo 'selected'?> value="6">Procident</option>
									<option <?php if($canal_scan=='7') echo 'selected'?> value="7">Autre</option>
							...
							<div class="col-md-12" style="" >
								...
								<select id="teg_typ" name="teg_typ" class="form-control">
                                    ...
                                    <option <?php if($tegem_scan=='1') echo 'selected'?> value="1">Normal</option>
									<option <?php if($tegem_scan=='2') echo 'selected'?> value="2">Procident</option>
							...
							<div class="col-md-12" style="" >
								...
								<select id="golf_jur" name="golf_jur" class="form-control">
                                    ...
                                    <option <?php if($golfe_scan=='1') echo 'selected'?> value="1">Normal</option>
									<option <?php if($golfe_scan=='2') echo 'selected'?> value="2">Déhiscent</option>
									<option <?php if($golfe_scan=='3') echo 'selected'?> value="3">Haut situe au dessus du plan de l’annulus</option>
						...
						<div class="col-md-6">
							...
							<div class="col-md-12" style="" >
								...
								<select id="ca_ca" name="ca_ca" class="form-control">
                                    ...
                                    <option <?php if($canalcaro_scan=='1') echo 'selected'?> value="1">Normal</option>
									<option <?php if($canalcaro_scan=='2') echo 'selected'?> value="2">Procident</option>
							...
							<div class="col-md-12" style="" >
								...
								<select id="sin_sig" name="sin_sig" class="form-control">
                                    ...
                                    <option <?php if($sinus_scan=='1') echo 'selected'?> value="1">Normal</option>
									<option <?php if($sinus_scan=='2') echo 'selected'?> value="2">Anterieur</option>
									<option <?php if($sinus_scan=='3') echo 'selected'?> value="3">Autre</option>
							...
							<div class="col-md-12" style="" >
								...
								<select id="sin_typ" name="sin_typ" class="form-control">
                                    ...
                                    <option <?php if($sinustymp_scan=='1') echo 'selected'?> value="1">A</option>
									<option <?php if($sinustymp_scan=='2') echo 'selected'?> value="2">B</option>
									<option <?php if($sinustymp_scan=='3') echo 'selected'?> value="3">C</option>
							...
							<div class="col-md-12" style="" >
								...
								<select id="re_fa_tdm" name="re_fa_tdm" class="form-control">
                                    ...
                                    <option <?php if($recessus_scan=='1') echo 'selected'?> value="1">Etroit</option>
									<option <?php if($recessus_scan=='2') echo 'selected'?> value="2">Large</option>
							...
							<div class="col-md-12" style="" >
								...
								<select id="cochl_tdm" name="cochl_tdm" class="form-control">
                                    ...
                                    <option <?php if($cochle_scan=='1') echo 'selected'?> value="1">Normale</option>
									 <optgroup label="Anormale (sennaroglu) TDM /IRM">
									<option <?php if($cochle_scan=='2') echo 'selected'?> value="2">absence compléte du labyrinthe</option>
									<option <?php if($cochle_scan=='3') echo 'selected'?> value="3">aplasie cochléaire</option>
									<option <?php if($cochle_scan=='4') echo 'selected'?> value="4">cavité commune</option>
									<optgroup label="partition incompléte de la cochlée">
									<option <?php if($cochle_scan=='5') echo 'selected'?> value="5">absence du modiolus et des septas</option>
									<option <?php if($cochle_scan=='6') echo 'selected'?> value="6">tour basal de la cochlée normal et hypoplasie du modiolus et fusion du
									<option <?php if($cochle_scan=='7') echo 'selected'?> value="7">modiolus absent et septas présents</option>
									</optgroup>
									<optgroup label="hypoplasie cochléaire">
									<option <?php if($cochle_scan=='8') echo 'selected'?> value="8">sans modiolus ni septas</option>
									<option <?php if($cochle_scan=='9') echo 'selected'?> value="9">cochlée kystique sans modiolus ni septas et architecture externe
									<option <?php if($cochle_scan=='10') echo 'selected'?> value="10">micro-cochlée &lt; 2 tours</option>
									</optgroup>
									<option <?php if($cochle_scan=='11') echo 'selected'?> value="11">LVAS  _ large vestibue aqueduc syndrome _</option>
									<option <?php if($cochle_scan=='12') echo 'selected'?> value="12">CAI étroit</option>
									 </optgroup>
								</select>
								</div>
							</div>
							<div class="col-md-12" style="" >
								...
								<select id="vest_tdm" name="vest_tdm" class="form-control">
                                    ...
                                    <option <?php if($vestibule_scan=='1') echo 'selected'?> value="1">Abscent</option>
									<option <?php if($vestibule_scan=='2') echo 'selected'?> value="2">Hypoplasique</option>
									<option <?php if($vestibule_scan=='3') echo 'selected'?> value="3">Dilatée</option>
							...
							<div class="col-md-12" style="" >
								...
								<select id="casecir_tdm" name="casecir_tdm" class="form-control">
                                    ...
                                    <option <?php if($semicer_scan=='1') echo 'selected'?> value="1">Abscent</option>
									<option <?php if($semicer_scan=='2') echo 'selected'?> value="2">Hypoplasique</option>
									<option <?php if($semicer_scan=='3') echo 'selected'?> value="3">Large</option>
							...
							<div class="col-md-12" style="" >
								...
								<select id="aqves_tdm" name="aqves_tdm" class="form-control">
                                    ...
                                    <option <?php if($aqueduc_scan=='1') echo 'selected'?> value="1">Normal</option>
									<option <?php if($aqueduc_scan=='2') echo 'selected'?> value="2">Dilaté supérieur a 1,5 mm</option>
							...
							<div class="col-md-12" style="" >
								...
								<select id="mod_tdm" name="mod_tdm" class="form-control">
                                    ...
                                    <option <?php if($modiolus_scan=='1') echo 'selected'?> value="1">Normal</option>
									<option <?php if($modiolus_scan=='2') echo 'selected'?> value="2">Hypoplasique</option>
									<option <?php if($modiolus_scan=='3') echo 'selected'?> value="3">Abscent</option>
							...
							<div class="col-md-12" style="" >
								...
								<select id="coai_tdm" name="coai_tdm" class="form-control">
                                    ...
                                    <option <?php if($coduit_scan=='1') echo 'selected'?> value="1">Normal</option>
									<option <?php if($coduit_scan=='2') echo 'selected'?> value="2">Etroit</option>
									<option <?php if($coduit_scan=='3') echo 'selected'?> value="3">Elargie</option>
							...
							<div class="col-md-12" style="" >
								...
								<select id="crb_tdm" name="crb_tdm" class="form-control">
                                    ...
                                    <option <?php if($cerebrale_scan=='1') echo 'selected'?> value="1">Calcification intracranienne</option>
									<option <?php if($cerebrale_scan=='2') echo 'selected'?> value="2">Dilatation ventriculaire</option>
									<option <?php if($cerebrale_scan=='3') echo 'selected'?> value="3">Atrophie</option>
