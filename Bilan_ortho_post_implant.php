	...
	<div class="row clearfix"> 
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="header">
                        <h2><strong>Bilan orthophonique post implant</strong> <small><a href="#" target="">ANAMNES:</a></small> </h2>
                    </div>
                    ...
                    <div class="body">
						...
						<div class="col-md-6">
                            ...
                            <div class="">
                                <div class="">
									<p><strong>Nom du patient :</strong> karim</p>
								</div>
                            </div>
							
							<div class="">
                                <div class="">
                                  <p><strong>Date de naissance :</strong> 1/10/1990</p>
                                </div>
                            </div>
							<div class="">                      
								<div class="">
							...
							<div class="">
                                <div class="">
									<p><strong>Degré de surdité au moment de l'implantation :</strong>  90°</p>
								</div>
                            </div>
							<div class="">                      
								<div class="" >                                    
                                   <p><strong>Medecin traitant :</strong>  Dr ilham</p>
                                </div>
                            </div>
							
							<div class="" style="" >
                                   <div class="" >                                    
                                   <p><strong>Laboratoire / marque de l'appareil :</strong>  Cochlear;neurelec;bioinics;med'el</p>
                                </div>                                 
                                
							</div>
							<div class="" style="" >
                                                                    
                               <p><strong>Prothese controlaterale :</strong>  oui/non droite/gauche</p>
							</div>
						...
						<div class="col-md-6">
						 <div class="">
							...
							<div class="">
									...
									<p><strong>Prenom du patient :</strong> adil</p>
								</div>
                            ...
                            <div class="">
							 <div class="">
                                        ...
                                        <p><strong>Scolarité / profession :</strong> Professeur</p>
                                    </div>
							...
							<div class="">
							 <div class="">
                                        ...
                                        <p><strong>Coté implanté : 1er implant :</strong>  droit/gauche</p>
							...
							<div class="" style="">                      
								<div class="" >                                    
                                    <p><strong>Coté implanté : 2eme implant :</strong>  droit/gauche</p>
                                   
                                </div>
                            </div>
							<div class="">                      
								<div class="form-group form-float" >                                    
                                     <p><strong>Type d'implant :</strong>  type</p>
                                   
                                </div>
                            </div>
							<div class="">
                                <div class="" >                                    
                                     <p><strong>Date de l'activation : </strong>1/10/1996</p>
							...
							<div class="" style="" >
                                ...
                                <div class="" >                                    
                                     <p><strong>Port de l'implant : </strong>Consatant,intermittent,partiel,irregulier</p>
