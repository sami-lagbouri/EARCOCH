...
if($_SERVER["REQUEST_METHOD"] == "POST"){
   ...
   $sql = "insert into reg_irm(date_irm, cente_irm, morpho_irm, signalt2_irm, signalt1_irm, modiolus_irm, conduit_irm,
cochle_irm, vestibulaire_irm, cerebrale_irm, check_irm,id_pat) values ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)";
   ...
   if(!empty($_POST['cente_irm'])) $cente_irm = $_POST['cente_irm'];
   ...
   $stmt= $db -> prepare($sql);
	...
	$stmt -> execute(array($date_irm,$centre_irm,$mo_lab,$mt_irm,$sf_irm,$smd,$cait,$nct_irm,$nerves_irm,$cer_irm,1,$pat_cons));
						...
						<div class="col-md-6">
							...
							<div class="col-md-12">                      
								<div class="form-group form-float">
									...
									<input type="text"  name="centre_irm" id="centre_irm" class="form-control" placeholder="Centre" style="font-size:15px">
								</div>
                            </div>
							<div class="col-md-12" style="" >
							...
							<div class="col-md-12" style="" >
								...
								<select id="mt_irm" name="mt_irm" class="form-control">
                                    ...
                                    <option value="1">Signal Normal</option>
									<option value="2">Hyposignal</option>
									<option value="3">Fibrose</option>
									<option value="4">Calcification</option>
							...
							<div class="col-md-12" style="" >
								...
								<select id="sf_irm" name="sf_irm" class="form-control">
                                    ...
                                    <option value="1">Signal Normal</option>
									<option value="2">Hyposignal</option>
									<option value="3">Hémorragie</option>
						...
						<div class="col-md-12" style="" >
							...
							<div class="col-md-12" style="" >
								...
								<select id="cait" name="cait" class="form-control">
									...
									<option value="1">Normal</option>
                                    <option value="2">Type 1 : Nerf cochléovestibulaire absent</option>
                                    <option value="3">type 2a : Aplasie du nerf cochléaire et présence d’un nerf commun avec anomalie du
labyrinthe</option>
									 <option value="4">type 2b : Aplasie du nerf cochléaire et présence d’un nerf sans anomalie du labyrinthe</option>
								</select>
								</div>
							</div>
							<div class="col-md-12" style="" >
							...
							<div class="col-md-12" style="" >
								...
								<select id="cer_irm" name="cer_irm" class="form-control">
                                    ...
                                    <option value="3">Anormale</option>
                                      </optgroup>
									
								
                                   <optgroup label="Noyaux Gris">
                                    <option value="4">Normaux</option>
                                    <option value="5">Anormaux</option>
                                    <option value="6">Autre</option>
                                   </optgroup>
                                    <optgroup label="Ventricule">
                                    <option value="7">Normal</option>
                                   
                                    <option value="8">Dilaté</option>
									 </optgroup>
                                     </optgroup>
